    ...
    <section ref={sectionRef} className="py-24 bg-white" id="how">
      <div className="max-w-6xl mx-auto px-7">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-5 relative">
          ...
          {/* Step 1 */}
          <div className="reveal relative z-10 text-center p-6 bg-cream rounded-2xl border-[1.5px] border-transparent hover:border-cream3 hover:shadow-lg hover:-translate-y-1 transition-all">
          ...
          {/* Step 2 */}
          <div className="reveal delay-1 relative z-10 text-center p-6 bg-cream rounded-2xl border-[1.5px] border-transparent hover:border-cream3 hover:shadow-lg hover:-translate-y-1 transition-all">
          ...
          {/* Step 3 */}
          <div className="reveal delay-2 relative z-10 text-center p-6 bg-cream rounded-2xl border-[1.5px] border-transparent hover:border-cream3 hover:shadow-lg hover:-translate-y-1 transition-all">
