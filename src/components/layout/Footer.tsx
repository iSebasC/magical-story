...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-teald py-16 pb-8">
      <div className="max-w-6xl mx-auto px-7">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-11 mb-12">
          ...
          <div>
            ...
            <p className="text-sm text-white/80 leading-relaxed mb-5 max-w-[220px]">
              ...
              who are falling in love with reading again.
            </p>
            <div className="flex gap-3">
              <a
                href="https://instagram.com/magicalstory"
              ...
              <a
                href="https://facebook.com/magicalstory"
                className="w-8 h-8 bg-white/10 rounded-full flex items-center justify-center hover:bg-white/20 transition-colors"
                aria-label="Facebook"
              >
                <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                href="https://youtube.com/@magicalstory"
                className="w-8 h-8 bg-white/10 rounded-full flex items-center justify-center hover:bg-white/20 transition-colors"
                aria-label="YouTube"
              >
                <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                href="https://tiktok.com/@magicalstory"
                className="w-8 h-8 bg-white/10 rounded-full flex items-center justify-center hover:bg-white/20 transition-colors"
                aria-label="TikTok"
              >
                <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Navigate */}
          <div>
            <h3 className="text-sm font-bold uppercase text-white tracking-wider mb-3.5">
              Navigate
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li>
                <a href="mailto:schools@magicalstory.com" className="text-sm text-white/80 hover:text-white transition-colors">
                  schools@magicalstory.com
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/20 pt-6 flex flex-col md:flex-row items-center justify-between gap-3">
          <p className="text-xs text-white/70">
            © 2025 Magical Story. All rights reserved.
          </p>
          <div className="flex gap-4">
            <a href="/privacy" className="text-xs text-white/70 hover:text-white transition-colors">
              Privacy
            </a>
            <a href="/terms" className="text-xs text-white/70 hover:text-white transition-colors">
              Terms
            </a>
            <a href="/cookies" className="text-xs text-white/70 hover:text-white transition-colors">
              Cookies
            </a>
          </div>
        </div>
