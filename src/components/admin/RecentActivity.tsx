...
import { Hand, BookOpen, Star, type LucideIcon } from 'lucide-react';
...
const activities: Activity[] = [
  { id: 1, type: 'signup', user: 'Ana Torres', detail: 'Signed up', time: '2m ago', icon: Hand },
  { id: 2, type: 'read', user: 'Sofia Rios', detail: 'Read "The Brave Lion"', time: '12m ago', icon: BookOpen },
  { id: 3, type: 'upgrade', user: 'Lucy Park', detail: 'Upgraded to Premium', time: '1h ago', icon: Star },
  { id: 4, type: 'read', user: 'Marcos López', detail: 'Read "Dragon of Paper"', time: '2h ago', icon: BookOpen },
  { id: 5, type: 'signup', user: 'Diego Fuentes', detail: 'Signed up', time: '3h ago', icon: Hand },
];
